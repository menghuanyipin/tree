...
// CONCATENATED MODULE: ./node_modules/_cache-loader@4.1.0@cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"55d12b70-vue-loader-template"}!./node_modules/_vue-loader@15.9.6@vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/_cache-loader@4.1.0@cache-loader/dist/cjs.js??ref--0-0!./node_modules/_vue-loader@15.9.6@vue-loader/lib??vue-loader-options!./src/components/Tree.vue?vue&type=template&id=55a93756&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _vm._m(0)}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{attrs:{"id":"treeMount"}})])}]


// CONCATENATED MODULE: ./src/components/Tree.vue?vue&type=template&id=55a93756&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/_@babel_runtime@7.12.5@@babel/runtime/helpers/esm/createForOfIteratorHelper.js
...
// CONCATENATED MODULE: ./node_modules/_cache-loader@4.1.0@cache-loader/dist/cjs.js??ref--12-0!./node_modules/_thread-loader@2.1.3@thread-loader/dist/cjs.js!./node_modules/_babel-loader@8.2.2@babel-loader/lib!./node_modules/_cache-loader@4.1.0@cache-loader/dist/cjs.js??ref--0-0!./node_modules/_vue-loader@15.9.6@vue-loader/lib??vue-loader-options!./src/components/Tree.vue?vue&type=script&lang=js&
...
/* harmony default export */ var Treevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    init: function init() {
      ...
      var ul = jquery_default()("<ul id='tree'></ul>"); // 递归生成目录树

      this.generatorTree(this.data, ul); // 如果需要隐藏根节点，则取出根节点下面的第一个ul作为根节点

      if (this.hideTopNode) {
        ul = jquery_default()(ul.find("ul")[0]);
      } // 取消顶级ul的padding-left
      ...
      jquery_default()("#treeMount").empty();
      jquery_default()("#treeMount").append(ul);
    },
     ...
     */
    watchCheckbox: function watchCheckbox(checkbox) {
      // 处理选中样式的变化
      var li = jquery_default()(checkbox).parent("li").parentsUntil("li").parent();
      var checked = true;

      var _iterator = _createForOfIteratorHelper(li.find("li").find("input")),
          _step;
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (jquery_default()(input).prop("checked") == false) {
            checked = false;
            break;
          }
        }
      ...
      jquery_default()(li.children("input")).prop("checked", checked);
    },

    /**
     * 获取tree目录上所有选中的节点的数据
     */
    watchTreeData: function watchTreeData() {
      var inputs = jquery_default()("input:checked");
      this.treeData = [];
     ...
     */
    findTreeData: function findTreeData(id, data) {
    ...
    // 递归生成树
    generatorTree: function generatorTree(data, container) {
      var _this = this;
      ...
      try {
        var _loop = function _loop() {
          ...
          var li = jquery_default()("<li></li>"); // 增加id属性

          li.attr("id", item.id); // 如果有checkbox，处理checkbox的全选，反选等事件

          if (_this.showCheckbox) {
            var box = jquery_default()("<input type='checkbox' value=".concat(item.id, ">"));
            box.css({
              width: "16px",
              height: "16px",
              "vertical-align": "top"
            ...
            box.on("click", function (event) {
              ...
              var li = jquery_default()(checkbox).parent("li"); // 全选和反选
          ...
          if (_this.showCheckbox) {
            li.on("click", "input", function (event) {
              event.stopPropagation();

              if (jquery_default()(event.target).prop("checked")) {
                _this.$emit("row", item);
              } else {
                _this.$emit("row", {});
              }

              _this.$emit("rows", _this.treeData);
            });
          } else {
          ...
          var span = jquery_default()("<span></span>"); // 计算标签的宽度
          ...
          span.css({
            ...
            width: "calc(100% - ".concat(spanWidth, "px)"),
          ...
          if (item.children && item.children.length > 0) {
            ...
            img.css({
              ...
              "vertical-align": "middle",
              // 箭头展开折叠的角度变化
              transform: _this.extend ? "rotate(0deg)" : "rotate(-90deg)"
            });
            img.on("click", function (event) {
              event.stopPropagation(); //   折叠处理
            ...
            li.prepend(img); // 生成孩子列表

            var ul = jquery_default()("<ul></ul>");
            ul.css({
              "list-style": "none",
              overflow: "hidden"
            });
            ...
            _this.generatorTree(item.children, ul);
          }
        };
...
// EXTERNAL MODULE: ./src/components/Tree.vue?vue&type=style&index=0&id=55a93756&lang=less&scoped=true&
var Treevue_type_style_index_0_id_55a93756_lang_less_scoped_true_ = __webpack_require__("d5e9");
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_0_9_0_mini_css_extract_plugin_dist_loader_js_ref_10_oneOf_1_0_node_modules_css_loader_3_6_0_css_loader_dist_cjs_js_ref_10_oneOf_1_1_node_modules_vue_loader_15_9_6_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_3_0_0_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_less_loader_5_0_0_less_loader_dist_cjs_js_ref_10_oneOf_1_3_node_modules_cache_loader_4_1_0_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_15_9_6_vue_loader_lib_index_js_vue_loader_options_Tree_vue_vue_type_style_index_0_id_55a93756_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("7361");
/* harmony import */ var _node_modules_mini_css_extract_plugin_0_9_0_mini_css_extract_plugin_dist_loader_js_ref_10_oneOf_1_0_node_modules_css_loader_3_6_0_css_loader_dist_cjs_js_ref_10_oneOf_1_1_node_modules_vue_loader_15_9_6_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_3_0_0_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_less_loader_5_0_0_less_loader_dist_cjs_js_ref_10_oneOf_1_3_node_modules_cache_loader_4_1_0_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_15_9_6_vue_loader_lib_index_js_vue_loader_options_Tree_vue_vue_type_style_index_0_id_55a93756_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_0_9_0_mini_css_extract_plugin_dist_loader_js_ref_10_oneOf_1_0_node_modules_css_loader_3_6_0_css_loader_dist_cjs_js_ref_10_oneOf_1_1_node_modules_vue_loader_15_9_6_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_3_0_0_postcss_loader_src_index_js_ref_10_oneOf_1_2_node_modules_less_loader_5_0_0_less_loader_dist_cjs_js_ref_10_oneOf_1_3_node_modules_cache_loader_4_1_0_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_15_9_6_vue_loader_lib_index_js_vue_loader_options_Tree_vue_vue_type_style_index_0_id_55a93756_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
